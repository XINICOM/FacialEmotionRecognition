...
from Back_end.model_src.src import load_fer2013, preprocessing, train_stream_packer
...
def main():
    ...
    history ,ans                            = train_stream_packer             (model_cfg["train"], train_loader, val_loader)
    print(history)
