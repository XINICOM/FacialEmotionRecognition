...
def train(model, train_loader, val_loader, start_epoch=0, best_val_acc=0.0,
    ...
    for epoch in range(start_epoch, cfg.NUM_EPOCHS):
        ...
        print(json.dumps({"total_epochs": cfg.NUM_EPOCHS, "current_epoch": epoch+1,
                       "train_loss": avg_train_loss, "train_acc": train_acc,
                       "val_loss": val_loss, "val_acc": val_acc}, ensure_ascii=False))
    ...
    return model, best_val_acc, epoch+1
